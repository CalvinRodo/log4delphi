...
{*----------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------}
   ...
   public
      ...
      procedure FatalException(const AMsg : String; const E : Exception);
      procedure ErrorException(const AMsg : String; const E : Exception);
      procedure WarnException(const AMsg : String; const E : Exception);
      procedure InfoException(const AMsg : String; const E : Exception);
      procedure DebugException(const AMsg : String; const E : Exception);
      procedure TraceException(const AMsg : String; const E : Exception);
...
{*----------------------------------------------------------------------------
   A generic form used to log a fatal exception.
  ----------------------------------------------------------------------------}
procedure TLogger.FatalException(const AMsg : String; const E : Exception);
begin
   log(TLevelUnit.FATAL, AMsg, E);
end;

{*----------------------------------------------------------------------------
   A generic form used to log an error exception.
  ----------------------------------------------------------------------------}
procedure TLogger.ErrorException(const AMsg : String; const E : Exception);
begin
   log(TLevelUnit.ERROR, AMsg, E);
end;

{*----------------------------------------------------------------------------
   A generic form used to log a warn exception.
  ----------------------------------------------------------------------------}
procedure TLogger.WarnException(const AMsg : String; const E : Exception);
begin
   log(TLevelUnit.WARN, AMsg, E);
end;

{*----------------------------------------------------------------------------
   A generic form used to log an info exception.
  ----------------------------------------------------------------------------}
procedure TLogger.InfoException(const AMsg : String; const E : Exception);
begin
   log(TLevelUnit.INFO, AMsg, E);
end;

{*----------------------------------------------------------------------------
   A generic form used to log a debug exception.
  ----------------------------------------------------------------------------}
procedure TLogger.DebugException(const AMsg : String; const E : Exception);
begin
   log(TLevelUnit.DEBUG, AMsg, E);
end;

{*----------------------------------------------------------------------------
   A generic form used to log a trace exception.
  ----------------------------------------------------------------------------}
procedure TLogger.TraceException(const AMsg : String; const E : Exception);
begin
   log(TLevelUnit.TRACE, AMsg, E);
end;
end.
